...
class MultiRabbitAutoConfigurationTest {
    ...
    void shouldEnsureAutoConfigurationBeans() {
        ...
        this.contextRunner
                .withPropertyValues("spring.rabbitmq.port=5672")
                .withPropertyValues("spring.multirabbitmq." + broker1 + ".port=5673")
                .withPropertyValues("spring.multirabbitmq." + broker2 + ".port=5674")
                .run((context) -> {
